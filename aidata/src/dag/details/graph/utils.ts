...
import { StateColorKey, stateColors } from "src/utils/globals";
...
export const nodeColor = ({
  ...
  if (instance?.state && !isOpen && instance.state in stateColors) {
    color = Color(stateColors[instance.state as StateColorKey]).hex();
  }
